...
RSpec.describe "PUT api/v1/tasks/:id", type: :request do
  ...
  describe 'unsuccessfull when' do
    ...
    describe 'no activity param' do
      ...
      it "response with error message" do
        expect(response_json["error_message"]).to eq "Internal problem. Contact support. Couldn't find Product without an ID"
      end
    ...
    describe 'wrong activity param' do
      ...
      it "response with error message" do
        expect(response_json["error_message"]).to eq "Internal problem. Contact support. No activity specified"
      end
    ...
    describe 'to many task items in task' do
      ...
      it "response with error message" do
        expect(response_json["error_message"]).to eq "You have to many products selected."
      end
    ...
    describe 'wrong task id param sent in' do
      ...
      it "response with error message" do
        expect(response_json["error_message"]).to eq "Internal problem. Contact support. Couldn't find Task with 'id'=1234567"
      end
